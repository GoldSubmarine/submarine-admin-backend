module.exports = {
    ...
    output: [
        ...
        // ==============backend==============
        {
            ...
            path: '<%= backRootPath %>/src/main/java/com/htnova/modules/<%= module %>/controller/<%= Entity %>Controller.java'
        },
        {
            template: 'service.ejs',
            path: '<%= backRootPath %>/src/main/java/com/htnova/modules/<%= module %>/service/<%= Entity %>Service.java'
        },
        {
            template: 'mapper.ejs',
            path: '<%= backRootPath %>/src/main/java/com/htnova/modules/<%= module %>/mapper/<%= Entity %>Mapper.java'
        },
        {
            template: 'entity.ejs',
            path: '<%= backRootPath %>/src/main/java/com/htnova/modules/<%= module %>/entity/<%= Entity %>.java'
        },
        {
            template: 'dto.ejs',
            path: '<%= backRootPath %>/src/main/java/com/htnova/modules/<%= module %>/dto/<%= Entity %>Dto.java'
        },
        {
            template: 'xml.ejs',
            path: '<%= backRootPath %>/src/main/java/com/htnova/modules/<%= module %>/xml/<%= Entity %>Mapper.xml'
        },
        {
            template: 'mapStruct.ejs',
            path: '<%= backRootPath %>/src/main/java/com/htnova/modules/<%= module %>/mapstruct/<%= Entity %>MapStruct.java'
        }
    ]
}
